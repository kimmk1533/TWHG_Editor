...
public class EditManager : Singleton<EditManager>
{
    ...
    {
        if (isEdit &&
            m_SafetyZone.m_Colliders.Count >= 2)
        {
    ...
    public void UpdateSafetyZone()
    {
        ...
        m_SafetyZone.m_StartPoint = m_SafetyZone.m_Colliders[first];
        m_SafetyZone.m_EndPoint = m_SafetyZone.m_Colliders[last];
    ...
    public void UpdateSafetyZoneOption()
    {
        ...
        for (int i = 0; i < m_SafetyZone.m_SafetyZones.Count; ++i)
        {
